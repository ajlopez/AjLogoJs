...
(function(exports)
{
	...
	Context.prototype.setProcedureReference = function(name, value)
	{
		this.procedures[name] = value;
	}
	
	Context.prototype.getProcedureReference = function(name)
	{
	...
	{
		return context.getProcedureReference(this.name);
	}
