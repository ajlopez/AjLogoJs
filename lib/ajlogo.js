...
(function(exports, module, top)
{
	...
	topcontext.setProcedure('forward', function(distance) {
		turtle.forward(distance);
	});
	
	topcontext.setProcedure('backward', function(distance) {
		turtle.backward(distance);
	});
	
	topcontext.setProcedure('left', function(degrees) {
		turtle.left(degrees);
	});
	
	topcontext.setProcedure('right', function(degrees) {
		turtle.right(degrees);
	});
	
	topcontext.setProcedure('home', function() {
		turtle.home();
	});
	...
	topcontext.setProcedure('penup', function() {
		turtle.penUp();
	});
	
	topcontext.setProcedure('pendown', function() {
		turtle.penDown();
	});
	...
	Turtle.prototype.heading = function() {
		return (this.degrees - 90 + 360) % 360;
	};
